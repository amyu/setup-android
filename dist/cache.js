...
import { ANDROID_HOME_DIR } from './constants.js';
...
export async function restoreCache(versions, cacheKey) {
...
export async function saveCache(versions, cacheKey) {
    const restoreKey = generateRestoreKey(versions, cacheKey);
...
export function getRestoredEntry() {
